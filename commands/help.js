...
const helpEmbed = new MessageEmbed()
    ...
    .addField('All the commands', '+ask, +ban, +covid, +dog, +help, +info, +invite, +kick, +lock, +mute, +info, +prune, +recipe, +roleban, +say, +status, +tempmute, +unlock, +unmute, +warn, +weaponinfo, +weather, +whois')
